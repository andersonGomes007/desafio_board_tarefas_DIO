...
import persistence.config.entity.BoardEntity;
import persistence.config.entity.CardEntity;
import service.BoardColumnQueryService;
import service.BoardQueryService;
import service.CardQueryService;
import service.CardService;

import static persistence.config.entity.BoardColumnKindEnum;
import java.sql.SQLException;
import java.util.Scanner;

import static persistence.config.converter.ConnectionConfig.getConnection;
